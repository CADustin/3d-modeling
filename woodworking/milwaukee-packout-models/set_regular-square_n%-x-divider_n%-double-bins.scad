...
translate([10,-$binLength/2,0])
generateTrayPct($binLength/2, $binDepth, $binHeightPct, $binWallThickness, $binBottomThickness, 0, $binRightChamfer);

translate([-$binLength/2,-$binLength/2,0])
generateTrayPct($binLength/2, $binDepth, $binHeightPct, $binWallThickness, $binBottomThickness, $binLeftChamfer, 0);